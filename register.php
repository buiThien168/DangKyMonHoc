                 ...
                 <form class="" action="http://localhost/dangkyhoc/xulydangky.php" method="POST">
                     <span class="">
                         <div align="center"> <span class="">
                                 <a href="http://localhost/dangkyhoc/view/quanlysinhvien.php">
                                     <img class="logo2" src="img/logo9.5.png">
                                 </a>
                             </span></div>
                     </span>
                     ...
                     <div class="text-center p-t-90">
                         <p class="" style="color: white">Quên mật khẩu?.
                             <a class="" style="color: white" href="http://localhost/dangkyhoc/quenmk.php">
                                 <u>Lấy lại</u>
                             </a>
                         </p>
