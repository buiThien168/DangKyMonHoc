...
<body>
    <div>
        ...
        * {
        ...
        <div id="menu">
            ...
            |
            <a href="dsdangky.php">Danh sách môn đã đăng ký</a>
            |
    ...
    if (mysqli_num_rows($kq) > 0) {
      {while ($row= mysqli_fetch_assoc($kq)) {
       ...
       ?>
        ...
        <div align="center" style="color: #00A005; font-size: 27px; margin: 20px">
  ...
  $kq=mysqli_query($conn,$sql);
       ...
       ?>
                ...
                <div class="hocphisum" style="display:flex;margin-left :15px;margin-top:15px;font-size:15px">
                    <h3>Tổng học phí: <?php echo $sum ?> k</h3>
                </div>
            </div>
