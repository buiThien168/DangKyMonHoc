    ...
    <body>
        ...
        <div style="padding-top: 60px">
            ...
            <div>
                <div align="center" style="font-size: 30px; margin: 20px;font-size:20px; font-weight:bold;">DANH SÁCH
                    MÔN HỌC</div>
                ...
                <div>
                    <form action="" method="POST">
                        ...
                        <table align="center" width="100%"
                            ...
                            <tbody>
                                <tr
                                    style="height: 50px; text-align: center; vertical-align:middle; background: #56a4fe;">
                                    <td><b>STT</b></td>
