            ...
            {while ($row= mysqli_fetch_assoc($kq)) {
                  ...
                  echo "<img height='150px' width='150px' style='border-radius: 50%;'' src='".$row['avatar']."'>";
                    ...
                    ?>
                                ...
                                <div align="center"
                                    style="color: black; font-size: 32px; font-weight: bold; padding: 20px;font-family: arial" <?php 
      include('../publish/connect.php');
    //Lấy dữ liệu nhập vào
    $username = $_SESSION['username'] ;
           ...
           $username = $_SESSION['username'] ;
                ...
                while ($row=mysqli_fetch_array($kq)) {
                    $masinhvien = $row['masinhvien'];
                     echo "<button class ='button' type =''><a style='text-decoration:none; font-weight: bold;; color: white;' href='../Controller/update_sinhvien.php?masinhvien=".$masinhvien."'>Chỉnh sửa</a></button>";
                }
              }
